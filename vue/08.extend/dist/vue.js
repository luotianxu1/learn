(function (global, factory) {
  ...
  strats.components = function (parentVal, childVal) {
    var res = Object.create(parentVal); //res.__protp__ = parentVal
    if (childVal) {
  ...
  function createComponent(vm, tag, data, key, children, Ctor) {
    ...
    var component = vnode(vm, "vue-component-".concat(Ctor.cid, "-").concat(tag), data, key, undefined, undefined, {
      Ctor: Ctor,
      children: children
    });
    return component;
  ...
  function vnode(vm, tag, data, key, children, text, componentOptions) {
    return {
      ...
      children: children,
      text: text,
      componentOptions: componentOptions //组件的虚拟节点多了一个componentOptions属性 用来保存当前组件的构造函数，和它的插槽
      // .....
    };
  }
