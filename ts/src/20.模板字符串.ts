...
type name = "jw"; // 模板字符串类型的目的就是将多个字符串组装在一起
...
type V1 = sayHehe<"jw">; // `hehe jw`
type V2 = sayHehe<123>;
type V3 = sayHehe<123n>;
type V4 = sayHehe<true>;
type V5 = sayHehe<null | undefined>;

type V6 = sayHehe<string>; // `hehe ${string}`
...
type FirstName = GristFirstName<"jiang wen">;
